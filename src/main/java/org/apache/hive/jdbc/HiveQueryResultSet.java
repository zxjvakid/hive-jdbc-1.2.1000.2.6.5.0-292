...
public class HiveQueryResultSet extends HiveBaseResultSet {
  ...
  public boolean next() throws SQLException {
    ...
    // NOTE: fetchOne dosn't throw new SQLException(Thread.currentThread().getStackTrace()[1].getMethodName()+"Method not supported").
    return true;
  }
  ...
  public <T> T getObject(String columnLabel, Class<T> type)  throws SQLException {
    //JDK 1.7
    throw new SQLException(Thread.currentThread().getStackTrace()[1].getMethodName()+"Method not supported");
  }
